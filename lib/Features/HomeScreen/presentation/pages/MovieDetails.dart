    ...
    return BlocProvider(
      ...
      child: BlocConsumer<PopularMoviesBloc, PopularMoviesState>(
        ...
        builder: (context, state) {
          return Scaffold(
            appBar: AppBar(
              backgroundColor: AppColors.iconadd,
                    ...
                    Stack(
                      ...
                      children: [
                        Container(
                            ...
                            child: Image.network(
                                fit: BoxFit.fill,
                                "${Constants.imagesurl}${PopularMoviesBloc.entity?.posterPath ?? ""}")),
                                  ...
                                  Positioned(
                                      ...
                                      child: IconButton(
                                        onPressed: () {
                                          ...
                                          PopularMoviesBloc.get(context).add(
                                              ClickMarkdetailsmovieEvent());
                                        },
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                height: 150,
                                child: Text(
                                    PopularMoviesBloc.entity?.overview ?? "",
                                    maxLines: 7,
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                      "${PopularMoviesBloc.entity?.voteAverage}",
                                ...
                                itemBuilder: (context, index) {
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: CardMovie(
                                          PopularMoviesBloc
                                              .moreLikeMovie[index].posterPath,
                                          PopularMoviesBloc.moreLikeMovie[index]
                                                  .select ??
                                              false,
                                          PopularMoviesBloc
                                              .moreLikeMovie[index].title,
                                          PopularMoviesBloc
                                              .moreLikeMovie[index].voteAverage,
                                          index,
                                          PopularMoviesBloc
                                              .moreLikeMovie[index].releaseDate,
                                          true),
                                    ),
                                  );
                                },
                                itemCount:
                                    PopularMoviesBloc.moreLikeMovie.length,
